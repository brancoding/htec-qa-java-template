...
import com.binzie.test.api.annotations.ResponseRequiredField;
import com.binzie.test.api.data.model.common.ErrorArrayResponse;
import com.binzie.test.api.data.model.common.ErrorResponse;
    ...
    public static ResponseValidation verifyResponse(String jsonResponse, Class modeledClass){
        ...
        if (jsonElement.isJsonArray()) {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ResponseValidation responseValidationTemp = GsonFunctions.verifyResponse(jsonArray.get(i).getAsJsonObject(), modeledClass);
